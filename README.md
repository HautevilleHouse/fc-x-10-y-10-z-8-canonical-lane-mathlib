# Generalized Fermat-Catalan (x^10+y^10=z^8) — Canonical Lane Mathlib

Mathlib-backed Canonical Lane formalization package for the Generalized Fermat-Catalan (x^10+y^10=z^8).

## Clean-clone replay

```bash
git clone https://github.com/HautevilleHouse/fc-x-10-y-10-z-8-mathlib.git
cd fc-x-10-y-10-z-8-mathlib
lake exe
lake build
```
