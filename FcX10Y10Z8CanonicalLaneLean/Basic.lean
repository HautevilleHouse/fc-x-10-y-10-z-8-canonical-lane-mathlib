/-!
# fc-x-10-y-10-z-8 Lean migration boundary
...
`fc_x_10_y_10_z_8/SourcePackage.lean`.
...
def sourceRepository : String := "fc-x-10-y-10-z-8"
def sourceUrl : String := "https://github.com/HautevilleHouse/fc-x-10-y-10-z-8"
def sourceDescription : String := "Canonical-lane closure package for the Generalized Fermat-Catalan (x^10+y^10=z^8): admissible-class formulation, projection gates, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["fc-x-10-y-10-z-8", "canonical-lane", "admissible-class", "mathematical-proof", "reproducibility"]
